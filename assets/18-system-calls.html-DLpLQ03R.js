...
<span class="line">  <span class="token comment"># note that for SYSCALL, the kernel segment selectors are:</span></span>
<span class="line">  <span class="token comment">#   CS: IA32_STAR[47:32]</span></span>
<span class="line">  <span class="token comment">#   SS: IA32_STAR[47:32] + 8</span></span>
<span class="line">  <span class="token comment"># and for SYSRET, the user segment selectors are:</span></span>
<span class="line">  <span class="token comment">#   CS: IA32_STAR[63:48] + 16</span></span>
<span class="line">  <span class="token comment">#   SS: IA32_STAR[63:48] + 8</span></span>
<span class="line">  <span class="token comment"># thus, setting both parts of the register to KernelCodeSegmentSelector</span></span>
<span class="line">  <span class="token comment"># satisfies both requirements (+0 is kernrel CS, +8 is data segment, +16 is user CS)</span></span>
...
<span class="line"><span class="token keyword">proc</span> <span class="token function">syscallEntry</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{.</span>asmNoStackFrame<span class="token punctuation">.}</span> <span class="token operator">=</span></span>
<span class="line">  <span class="token keyword">asm</span> <span class="token string">&quot;&quot;&quot;</span>
<span class="line highlighted">    # switch to kernel stack</span>
<span class="line highlighted">    mov %0, rsp</span>
<span class="line highlighted">    mov rsp, %1</span>
<span class="line highlighted"></span>
<span class="line highlighted">    # save user rip and rflags    </span>
<span class="line highlighted">    push rcx</span>
<span class="line highlighted">    push r11</span>
<span class="line"></span>
<span class="line">    # TODO: dispatch system call</span>
<span class="line"></span>
<span class="line highlighted">    # restore user rip and rflags</span>
<span class="line highlighted">    pop r11</span>
<span class="line highlighted">    pop rcx</span>
<span class="line highlighted"></span>
<span class="line highlighted">    # switch to user stack</span>
<span class="line highlighted">    mov rsp, %0</span>
<span class="line"></span>
<span class="line">    sysretq</span>
<span class="line highlighted">    : &quot;+r&quot;(\`userRsp\`)</span>
<span class="line highlighted">    : &quot;m&quot;(\`kernelStackAddr\`)</span>
...
<span class="line">  SyscallArgs<span class="token operator">*</span> <span class="token operator">=</span> <span class="token keyword">object</span></span>
...
<span class="line"></span>
<span class="line highlighted">    # create SyscallArgs on stack</span>
...
<span class="line highlighted"></span>
<span class="line highlighted">    mov rdi, rsp  # address of SyscallArgs</span>
<span class="line highlighted">    call syscall</span>
<span class="line highlighted"></span>
<span class="line highlighted">    # restore registers</span>
...
<span class="line"></span>
<span class="line">    # prepare for sysret</span>
<span class="line">    pop rcx  # rip</span>
<span class="line">    pop r11  # rflags</span>
<span class="line"></span>
...
<span class="line highlighted">    : &quot;rdi&quot;, &quot;rsi&quot;</span>
<span class="line">  &quot;&quot;&quot;</span></span>
