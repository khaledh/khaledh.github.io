...
<span class="line"><span class="token key attr-name">--passl</span><span class="token punctuation">:</span><span class="token value attr-value">&quot;-entry=UserlMain&quot;</span></span>
...
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>The proc allows loading an image at a specific address (if <code>loadAddress</code> is provided), or at any address (if <code>loadAddress</code> is <code>none</code>). The former is useful for loading the kernel image, since we want to load it at a specific address. The latter is useful for loading the user program, since we don&#39;t care where it&#39;s loaded.</p><p>Let&#39;s now update the <code>EfiMainInner</code> by replacing that section of the code with two calls to <code>loadImage</code>.</p><div class="language-nim line-numbers-mode" data-highlighter="prismjs" data-ext="nim" data-title="nim"><pre><code><span class="line"><span class="token comment"># src/boot/bootx64.nim</span></span>
...
<span class="line highlighted">    userTaskPhysicalBase<span class="token operator">*:</span> uint64</span>
<span class="line highlighted">    userTaskPages<span class="token operator">*:</span> uint64</span>
...
<span class="line"></span>
<span class="line">  debugln <span class="token operator">&amp;</span><span class="token string">&quot;kernel:   Mapping user image ({UserImageVirtualBase} -&gt; {bootInfo.userImagePhysicalBase:#x})&quot;</span></span>
...
<span class="line">ES =001b 0000000000000000 000fffff 000ff300 DPL=3 DS   [-WA]</span>
<span class="line highlighted">CS =0013 0000000000000000 000fffff 002ffa00 DPL=3 CS64 [-R-]</span>
<span class="line">SS =001b 0000000000000000 000fffff 000ff300 DPL=3 DS   [-WA]</span>
<span class="line">DS =001b 0000000000000000 000fffff 000ff300 DPL=3 DS   [-WA]</span>
<span class="line">FS =001b 0000000000000000 000fffff 000ff300 DPL=3 DS   [-WA]</span>
<span class="line">GS =001b 0000000000000000 000fffff 000ff300 DPL=3 DS   [-WA]</span>
