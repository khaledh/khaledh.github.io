...
The page tables are stored in memory, and the physical address of the root of the tree
...
Let's also add a couple of templates for pointer arithmetic on virtual addresses, which
